...
import { useAuth } from '../context/AuthContext'; // Importar o nosso hook de autenticação
...
export const RegisterPage: React.FC = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        // Criamos o objeto do novo utilizador
        const newUser = { name, email, cro, phone, city, state, profilePic };
        
        // Fazemos o login com os dados do novo utilizador
        login(newUser);

        // Navegamos para o Dashboard
        navigate('/');
    };
